...
import { PORT, WEBHOOK_SECRET, FARM_URL, FARM_SHARED_SECRET } from './config.js'
import { getActiveProjectId, getRepoUrl, getToken, setSetting } from './settings.js'
...
fastify.post('/api/webhooks/github', (request, reply) => {
  ...
  // TODO: 'issue_comment' → feedback ingestion ("users interact mostly by GH comments")
